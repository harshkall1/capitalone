        ...
        <div className="account-container">
            <div className="account-header page-bx">
                <div className="top-header">
                    <img src="https://d1.awsstatic.com/Customer%20References%20Directory%20Logos/Capital-One_Logo_%401x.0aef0b700254d3f618484ff03747100753de3d64.png" alt="logo" className="logo" />
